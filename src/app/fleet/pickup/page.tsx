      ...
      <main className="pt-header min-h-screen bg-surface-page">
        ...
        <div className="py-16 md:py-24 relative overflow-hidden bg-[#FAFAF8] border-b border-ink-ghost/10">
          ...
          <div className="container-xl relative z-10">
            <Tag variant="brand" size="sm" className="mb-4">Light Commercial</Tag>
            <h1 className="font-display font-black text-5xl md:text-6xl text-ink-strong tracking-tight mb-4">
              Pickup Fleet<br />
              <span className="text-gradient-energy">Fast. Agile. City-ready.</span>
            </h1>
            <p className="text-ink-muted text-xl max-w-2xl mb-8">
              BGTS Pickup vehicles handle city express, last-mile, and same-day delivery
              runs across Gujarat and Maharashtra — Bolero Pickup, Tata Ace, and Mahindra Jeeto.
            </p>
