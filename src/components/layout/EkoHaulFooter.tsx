        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="font-display font-black text-white text-xl">BGTS EV</span>
          ...
          <div className="flex flex-col gap-2">
            <a
              ...
              className="flex items-center gap-2 text-white/60 hover:text-white text-base font-mono transition-colors"
            >
              <Phone size={15} className="text-eko-lime" aria-hidden="true" />
              +91 63 5722 5722
            </a>
          </div>
        </div>

        <div className="mt-8 pt-6 border-t border-white/10 text-white/30 text-sm">
